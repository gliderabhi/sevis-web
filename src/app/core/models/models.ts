...
export interface LabourItemInfo   { id: number; description: string; type: string; technicianId?: number; technicianName?: string; taskStatus: string; quantity: number; rate: number; amount: number; }
export interface Technician       { id: number; userId?: number | null; name: string; phone?: string; specialisation?: string; employeeCode?: string; panNumber?: string; aadhaarNumber?: string; active: boolean; dealerId?: number | null; joinedDate?: string; leftDate?: string; }
