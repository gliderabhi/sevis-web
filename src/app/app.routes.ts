...
export const routes: Routes = [
  ...
  {
    path: '',
    loadComponent: () => import('./features/shell/shell/shell').then(m => m.ShellComponent),
    ...
    children: [
      ...
      { path: 'inventory', loadComponent: () => import('./features/inventory/inventory/inventory').then(m => m.InventoryComponent) },
      { path: 'billing',   loadComponent: () => import('./features/billing/billing/billing').then(m => m.BillingComponent) },
      { path: 'reports',   loadComponent: () => import('./features/reports/reports/reports').then(m => m.ReportsComponent) },
      { path: 'users',     loadComponent: () => import('./features/users/users/users').then(m => m.UsersComponent) },
    ],
  },
  { path: '**', redirectTo: '' },
];
